...
public partial class BookManagementDbContext : DbContext
{
    ...
    //hàm đọc chuỗi kết nối từ appsettings.json
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C2079C5F2A03");
        ...
        {
            entity.HasKey(e => e.BookCategoryId).HasName("PK__BookCate__6347EC0423E69C74");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__UserAcco__0CF04B182EE4B8C1");
